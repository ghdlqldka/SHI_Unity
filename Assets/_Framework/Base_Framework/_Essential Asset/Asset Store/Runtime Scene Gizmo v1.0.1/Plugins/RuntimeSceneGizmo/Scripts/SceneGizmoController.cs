...
namespace RuntimeSceneGizmo
{
	...
	{
        protected const int GIZMOS_LAYER = 24;

#pragma warning disable 0649
		[SerializeField]
		protected Camera gizmoCamera;
        protected Transform gizmoCamParent;

		[SerializeField]
        protected Renderer[] gizmoComponents;

		[SerializeField]
        protected TextMesh[] labels;
        protected Transform[] labelsTR;
#pragma warning restore 0649

		protected Transform m_referenceTransform;
        ...
        protected Material gizmoNormalMaterial, gizmoFadeMaterial, gizmoHighlightMaterial;
        protected int gizmoMaterialFadeProperty;

		protected GizmoComponent highlightedComponent = GizmoComponent.None;
        protected GizmoComponent fadingComponent = GizmoComponent.None;
        protected bool isFadingToZero;
        protected float fadeT = 1f;

        protected bool updateTargetTexture;
		public RenderTexture TargetTexture { get; protected set; }
		...
		public virtual GizmoComponent Raycast( Vector3 normalizedPosition )
		{
			RaycastHit hit;
		...
		public virtual void OnPointerHover( Vector3 normalizedPosition )
		{
        ...
        protected void SetHiddenComponent( GizmoComponent component )
		{
        ...
        protected void SetAlphaOf( GizmoComponent component, float alpha )
		{
			if( component == GizmoComponent.None )
				return;
        ...
        protected void SetMaterialOf( GizmoComponent component, Material material )
		{
			if( component == GizmoComponent.None )
				return;
        ...
        protected GizmoComponent GetOppositeComponent( GizmoComponent component )
		{
