...
public class TapDetector : MonoBehaviour {
	...
	protected List<int> fingerIndex=new List<int>();
	protected List<int> mouseIndex=new List<int>();
	
	protected MultiTapTracker[] multiTapMFTouch=new MultiTapTracker[5];
	protected MultiTapTracker[] multiTapTouch=new MultiTapTracker[5];
	protected MultiTapTracker[] multiTapMouse=new MultiTapTracker[2];
	...
	protected enum _ChargeState{Clear, Charging, Charged}
	...
	protected static TapDetector instance;
	...
	protected virtual void CheckMultiTapMouse(int index, Vector2 startPos, Vector2 lastPos){
	...
	protected virtual void CheckMultiTapTouch(int index, Vector2 startPos, Vector2 lastPos){
	...
	protected virtual IEnumerator CheckMultiTapCount(){
		while(true){
	...
	protected virtual IEnumerator FingerRoutine(int index){
	...
	protected virtual IEnumerator MouseRoutine(int index){
	...
	protected List<FingerGroup> fingerGroup=new List<FingerGroup>();
	protected IEnumerator MultiFingerRoutine(){
		while(true){
	...
	protected virtual void CheckFingerGroup(Touch touch){
	...
	protected bool IndexInFingerGroup(int index){
		for(int i=0; i<fingerGroup.Count; i++){
