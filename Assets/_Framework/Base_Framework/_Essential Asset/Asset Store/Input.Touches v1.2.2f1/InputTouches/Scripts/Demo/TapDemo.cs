...
public class TapDemo : MonoBehaviour {
	...
	protected virtual void OnMultiTap(Tap tap){
	...
	protected virtual void OnLongTap(Tap tap){
		//do a raycast base on the position of the tap
		Ray ray = Camera.main.ScreenPointToRay(tap.pos);
		RaycastHit hit;
	...
	protected IEnumerator ResumeSpeed(){
		var main = Indicator.main;
	...
	*/
	...
	protected Vector3 dragOffset1;
	protected Vector3 dragOffset2;
	
	protected int currentDragIndex1=-1;
	protected int currentDragIndex2=-1;
	...
	protected void OnDragging(DragInfo dragInfo){
	...
	protected virtual void Obj1ToCursor(DragInfo dragInfo){
	...
	protected virtual void Obj2ToCursor(DragInfo dragInfo){
		Vector3 p=Camera.main.ScreenToWorldPoint(new Vector3(dragInfo.pos.x, dragInfo.pos.y, 30));
	...
	protected virtual void OnDraggingEnd(DragInfo dragInfo){
