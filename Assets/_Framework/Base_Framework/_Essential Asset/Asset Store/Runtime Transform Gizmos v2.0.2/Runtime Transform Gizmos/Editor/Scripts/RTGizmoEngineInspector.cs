...
namespace RTG
{
    ...
    {
        protected const int _generalTab = 0;
        protected const int _sceneGizmo = _generalTab + 1;
        protected const int _moveGizmoTab = _sceneGizmo + 1;
        protected const int _rotationGizmoTab = _moveGizmoTab + 1;
        protected const int _scaleGizmoTab = _rotationGizmoTab + 1;
        protected const int _universalGizmoTab = _scaleGizmoTab + 1;
