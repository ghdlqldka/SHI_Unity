...
namespace RTG
{
    ...
    public class RTFocusCamera : MonoSingleton<RTFocusCamera>
    {
        ...
        protected WorldTransformSnapshot _worldTransformSnapshot = new WorldTransformSnapshot();
        protected CameraPrjSwitchTransition _prjSwitchTranstion = new CameraPrjSwitchTransition();
...
//             }       
        ...
        protected virtual void OnPrjSwitchTransitionBegin(CameraPrjSwitchTransition.Type transitionType)
        {
            if (PrjSwitchTransitionBegin != null) PrjSwitchTransitionBegin(transitionType);
        }

        protected void OnPrjSwitchTransitionUpate(CameraPrjSwitchTransition.Type transitionType)
        {
            if (PrjSwitchTransitionUpdate != null) PrjSwitchTransitionUpdate(transitionType);
        }

        protected void OnPrjSwitchTransitionEnd(CameraPrjSwitchTransition.Type transitionType)
        {
