...
namespace RTG
{
    ...
    public class Gizmo
    {
        ...
        protected GizmoHandleCollection _handles;
        protected GizmoBehaviourCollection _behaviours = new GizmoBehaviourCollection();

        protected GizmoHoverInfo _hoverInfo = new GizmoHoverInfo();
        protected GizmoDragInfo _dragInfo = new GizmoDragInfo();
        protected IGizmoHandle _hoveredHandle;
        ...
        [NonSerialized]
        protected MoveGizmo _moveGizmo;
        [NonSerialized]
        protected RotationGizmo _rotationGizmo;
        [NonSerialized]
        protected ScaleGizmo _scaleGizmo;
        [NonSerialized]
        protected UniversalGizmo _universalGizmo;
        [NonSerialized]
        protected ObjectTransformGizmo _objectTransformGizmo;
        [NonSerialized]
        ...
        public virtual BehaviourType AddBehaviour<BehaviourType>()
        ...
        public virtual bool AddBehaviour(IGizmoBehaviour behaviour)
        {
        ...
        public virtual void UpdateHandleHoverInfo_SystemCall(GizmoHoverInfo hoverInfo)
        {
        ...
        public virtual void HandleInputDeviceEvents_SystemCall()
        {
            if (!IsEnabled) return;
        ...
        protected virtual void OnInputDevicePickButtonDown()
        {
        ...
        protected virtual void OnInputDevicePickButtonUp()
        {
            EndDragSession();      
        }

        protected void EndDragSession()
        {
        ...
        protected void OnInputDeviceMoved()
        {
