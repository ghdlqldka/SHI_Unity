...
namespace RTG
{
    public class TerrainGizmo : GizmoBehaviour
    {
        ...
        protected List<Vector3> _modelRadiusCirclePoints = new List<Vector3>();
        protected List<Vector3> _radiusCirclePoints = new List<Vector3>();
        ...
        protected GizmoLineSlider3D _axisSlider;
        protected GizmoCap3D _midCap;

        protected RadiusTick _leftRadiusTick;
        protected RadiusTick _rightRadiusTick;
        protected RadiusTick _backRadiusTick;
        protected RadiusTick _forwardRadiusTick;
