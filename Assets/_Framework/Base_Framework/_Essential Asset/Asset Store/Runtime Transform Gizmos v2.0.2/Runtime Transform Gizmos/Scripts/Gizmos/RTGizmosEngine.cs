...
namespace RTG
{
    ...
    public class RTGizmosEngine : MonoSingleton<RTGizmosEngine>, IHoverableSceneEntityContainer
    {
        ...
        [SerializeField]
        protected EditorToolbar _mainToolbar = new EditorToolbar
        (
        ...
        protected GizmosEnginePipelineStage _pipelineStage = GizmosEnginePipelineStage.Update;
        protected Gizmo _draggedGizmo;
        protected bool _justReleasedDrag = false;
        protected Gizmo _hoveredGizmo;
        protected GizmoHoverInfo _gizmoHoverInfo;
        protected List<Gizmo> _gizmos = new List<Gizmo>();
        protected List<ISceneGizmo> _sceneGizmos = new List<ISceneGizmo>();
        protected List<RTSceneGizmoCamera> _sceneGizmoCameras = new List<RTSceneGizmoCamera>();
        ...
        [SerializeField]
        protected MoveGizmoSettings2D _moveGizmoSettings2D = new MoveGizmoSettings2D() { IsExpanded = false };
        [SerializeField]
        protected MoveGizmoSettings3D _moveGizmoSettings3D = new MoveGizmoSettings3D() { IsExpanded = false };
        [SerializeField]
        protected MoveGizmoLookAndFeel2D _moveGizmoLookAndFeel2D = new MoveGizmoLookAndFeel2D() { IsExpanded = false };
        [SerializeField]
        protected MoveGizmoLookAndFeel3D _moveGizmoLookAndFeel3D = new MoveGizmoLookAndFeel3D() { IsExpanded = false };
        [SerializeField]
        protected MoveGizmoHotkeys _moveGizmoHotkeys = new MoveGizmoHotkeys() { IsExpanded = false };
        [SerializeField]
        protected ObjectTransformGizmoSettings _objectMoveGizmoSettings = new ObjectTransformGizmoSettings() { IsExpanded = false };

        [SerializeField]
        protected RotationGizmoSettings3D _rotationGizmoSettings3D = new RotationGizmoSettings3D() { IsExpanded = false };
        [SerializeField]
        protected RotationGizmoLookAndFeel3D _rotationGizmoLookAndFeel3D = new RotationGizmoLookAndFeel3D() { IsExpanded = false };
        [SerializeField]
        protected RotationGizmoHotkeys _rotationGizmoHotkeys = new RotationGizmoHotkeys() { IsExpanded = false };
        [SerializeField]
        protected ObjectTransformGizmoSettings _objectRotationGizmoSettings = new ObjectTransformGizmoSettings() { IsExpanded = false };

        [SerializeField]
        protected ScaleGizmoSettings3D _scaleGizmoSettings3D = new ScaleGizmoSettings3D() { IsExpanded = false };
        [SerializeField]
        protected ScaleGizmoLookAndFeel3D _scaleGizmoLookAndFeel3D = new ScaleGizmoLookAndFeel3D() { IsExpanded = false };
        [SerializeField]
        protected ScaleGizmoHotkeys _scaleGizmoHotkeys = new ScaleGizmoHotkeys() { IsExpanded = false };
        [SerializeField]
        protected ObjectTransformGizmoSettings _objectScaleGizmoSettings = new ObjectTransformGizmoSettings() { IsExpanded = false };

        [SerializeField]
        private UniversalGizmoConfig _universalGizmoConfig = new UniversalGizmoConfig();
        [SerializeField]
        protected UniversalGizmoSettings2D _universalGizmoSettings2D = new UniversalGizmoSettings2D() { IsExpanded = false };
        [SerializeField]
        protected UniversalGizmoSettings3D _universalGizmoSettings3D = new UniversalGizmoSettings3D() { IsExpanded = false };
        [SerializeField]
        protected UniversalGizmoLookAndFeel2D _universalGizmoLookAndFeel2D = new UniversalGizmoLookAndFeel2D() { IsExpanded = false };
        [SerializeField]
        protected UniversalGizmoLookAndFeel3D _universalGizmoLookAndFeel3D = new UniversalGizmoLookAndFeel3D() { IsExpanded = false };
        [SerializeField]
        protected UniversalGizmoHotkeys _universalGizmoHotkeys = new UniversalGizmoHotkeys() { IsExpanded = false };
        [SerializeField]
        protected ObjectTransformGizmoSettings _objectUniversalGizmoSettings = new ObjectTransformGizmoSettings() { IsExpanded = false };
        ...
        public Camera RenderStageCamera { get { return RTGApp.Get.RenderCamera; } }
        ...
        public bool JustReleasedDrag { get { return _justReleasedDrag; } }
        ...
        public virtual RTSceneGizmoCamera CreateSceneGizmoCamera(Camera sceneCamera, ISceneGizmoCamViewportUpdater viewportUpdater)
        {
        ...
        public virtual Gizmo CreateGizmo()
        {
        ...
        public virtual SceneGizmo CreateSceneGizmo(Camera sceneCamera)
        {
        ...
        public virtual MoveGizmo CreateMoveGizmo()
        {
        ...
        public virtual ObjectTransformGizmo CreateObjectMoveGizmo()
        {
        ...
        public virtual RotationGizmo CreateRotationGizmo()
        {
            Gizmo gizmo = CreateGizmo();
        ...
        public virtual ObjectTransformGizmo CreateObjectRotationGizmo()
        {
        ...
        public virtual ScaleGizmo CreateScaleGizmo()
        {
            Gizmo gizmo = CreateGizmo();
        ...
        public virtual ObjectTransformGizmo CreateObjectScaleGizmo()
        {
        ...
        public virtual UniversalGizmo CreateUniversalGizmo()
        {
            Gizmo gizmo = CreateGizmo();
        ...
        public virtual ObjectTransformGizmo CreateObjectUniversalGizmo()
        {
        ...
        public virtual void Update_SystemCall()
        {
        ...
        protected void SortHandleHoverDataCollection(List<GizmoHandleHoverData> hoverDataCollection, Vector3 inputDevicePos)
        {
        ...
        protected void OnGizmoDragBegin(Gizmo gizmo, int handleId)
        {
            _draggedGizmo = gizmo;
        }

        protected void OnGizmoDragEnd(Gizmo gizmo, int handleId)
        {
            _draggedGizmo = null;
            _justReleasedDrag = true;
        }
    }
}
