...
namespace RTG
{
    ...
    public class UniversalGizmo : GizmoBehaviour
    {
        ...
        protected GizmoLineSlider3DCollection _mvAxesSliders = new GizmoLineSlider3DCollection();

        private GizmoPlaneSlider3D _mvXYSlider;
        private GizmoPlaneSlider3D _mvYZSlider;
        private GizmoPlaneSlider3D _mvZXSlider;
        protected GizmoPlaneSlider3DCollection _mvDblSliders = new GizmoPlaneSlider3DCollection();
        ...
        protected GizmoPlaneSlider3DCollection _rtAxesSliders = new GizmoPlaneSlider3DCollection();

        protected GizmoCap3D _rtMidCap;
        private GizmoDblAxisRotationDrag3D _rtCamXYRotationDrag = new GizmoDblAxisRotationDrag3D();

        protected GizmoPlaneSlider2D _rtCamLookSlider;
        #endregion

        #region Scale
        protected GizmoCap3D _scMidCap;
        ...
        protected virtual void SetMoveHandlesVisible(bool visible)
        {
            Debug.Log("SetMoveHandlesVisible(), visible : " + visible);
        ...
        protected virtual void SetRotationHandlesVisible(bool visible)
        {
            Debug.Log("SetRotationHandlesVisible(), visible : " + visible);
        ...
        protected virtual void SetScaleHandlesVisible(bool visible)
        {
            Debug.Log("SetScaleHandlesVisible(), visible : " + visible);
