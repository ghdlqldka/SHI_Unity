...
namespace IngameDebugConsole
{
	...
	{
		public static DebugLogManager Instance { get; protected set; }
...
#pragma warning disable 0649
        ...
        protected float minimumHeight = 200f;

		[SerializeField]
		[HideInInspector]
		[Tooltip( "If enabled, console window can be resized horizontally, as well" )]
        protected bool enableHorizontalResizing = false;
        ...
        protected bool resizeFromRight = true;

		[SerializeField]
		[HideInInspector]
		[Tooltip( "Minimum width of the console window" )]
        protected float minimumWidth = 240f;

		[SerializeField]
		[HideInInspector]
		[Tooltip( "Opacity of the console window" )]
		[Range( 0f, 1f )]
        protected float logWindowOpacity = 1f;
        ...
        protected PopupVisibility popupVisibility = PopupVisibility.Always;

		[SerializeField]
		[HideInInspector]
		[Tooltip( "Determines which log types will show the popup on screen" )]
        protected DebugLogFilter popupVisibilityLogFilter = DebugLogFilter.All;
        ...
        protected bool toggleWithKey = false;
        ...
        protected bool enableSearchbar = true;
        ...
        protected float topSearchbarMinWidth = 360f;
        ...
        protected bool receiveLogsWhileInactive = false;

		[SerializeField]
		[HideInInspector]
        protected bool receiveInfoLogs = true, receiveWarningLogs = true, receiveErrorLogs = true, receiveExceptionLogs = true;

		[SerializeField]
		[HideInInspector]
		[Tooltip( "If enabled, the arrival times of logs will be recorded and displayed when a log is expanded" )]
        protected bool captureLogTimestamps = false;
        ...
        protected int maxLogCount = int.MaxValue;
        ...
        protected int logsToRemoveAfterMaxLogCount = 16;
        ...
        protected int queuedLogLimit = 256;
		...
		protected bool receiveLogcatLogsInAndroid = false;
...
#pragma warning restore 0414
        ...
        protected bool autoFocusOnCommandInputField = true;
#endif

		[Header( "Visuals" )]
		[SerializeField]
        protected DebugLogItem logItemPrefab;

        [SerializeField]
        public TMP_FontAsset logItemFontOverride;
		...
		[SerializeField]
        protected Sprite infoLog;
		[SerializeField]
        protected Sprite warningLog;
		[SerializeField]
        protected Sprite errorLog;

		public static Sprite[] logSpriteRepresentations;

		// Visuals for resize button
		[SerializeField]
        protected Sprite resizeIconAllDirections;
		[SerializeField]
        protected Sprite resizeIconVerticalOnly;
		...
		[SerializeField]
        protected Color filterButtonsSelectedColor;
		...
		[SerializeField]
		protected RectTransform logWindowTR;
		...
		[SerializeField]
        protected RectTransform commandSuggestionsContainer;

		[SerializeField]
        protected TMP_InputField commandInputField;
		...
		[SerializeField]
        protected Image filterInfoButton;
		[SerializeField]
        protected Image filterWarningButton;
		[SerializeField]
        protected Image filterErrorButton;

		[SerializeField]
        protected TextMeshProUGUI infoEntryCountText;
		[SerializeField]
        protected TextMeshProUGUI warningEntryCountText;
		[SerializeField]
        protected TextMeshProUGUI errorEntryCountText;

		[SerializeField]
        protected RectTransform searchbar;
		[SerializeField]
        protected RectTransform searchbarSlotTop;
		[SerializeField]
        protected RectTransform searchbarSlotBottom;

		[SerializeField]
        protected Image resizeButton;
		...
		[SerializeField]
		protected CanvasGroup logWindowCanvasGroup;
        ...
        protected RectTransform logItemsScrollRectTR;
        protected Vector2 logItemsScrollRectOriginalSize;

		// Recycled list view to handle the log items efficiently
		[SerializeField]
        protected DebugLogRecycledListView recycledListView;
#pragma warning restore 0649

        protected bool isLogWindowVisible = true;
        ...
        protected bool screenDimensionsChanged = true;
        protected float logWindowPreviousWidth;

        // Number of entries filtered by their types
        protected int infoEntryCount = 0, warningEntryCount = 0, errorEntryCount = 0;
        protected bool entryCountTextsDirty;

        // Number of new entries received this frame
        protected int newInfoEntryCount = 0, newWarningEntryCount = 0, newErrorEntryCount = 0;
        ...
        protected DynamicCircularBuffer<DebugLogEntry> collapsedLogEntries;
        protected DynamicCircularBuffer<DebugLogEntryTimestamp> collapsedLogEntriesTimestamps;

        // Dictionary to quickly find if a log alrprotectedeady exists in collapsedLogEntries
        protected Dictionary<DebugLogEntry, DebugLogEntry> collapsedLogEntriesMap;

        // The order the collapsedLogEntries are received 
        // (duplicate entries have the same value)
        protected DynamicCircularBuffer<DebugLogEntry> uncollapsedLogEntries;
        protected DynamicCircularBuffer<DebugLogEntryTimestamp> uncollapsedLogEntriesTimestamps;

		// Filtered list of debug entries to show
		protected DynamicCircularBuffer<DebugLogEntry> logEntriesToShow;
        protected DynamicCircularBuffer<DebugLogEntryTimestamp> timestampsOfLogEntriesToShow;

        // The log entry that must be focused this frame
        protected int indexOfLogEntryToSelectAndFocus = -1;

        // Whether or not logs list view should be updated this frame
        protected bool shouldUpdateRecycledListView = true;

        // Logs that should be registered in Update-loop
        protected DynamicCircularBuffer<QueuedDebugLogEntry> queuedLogEntries;
        protected DynamicCircularBuffer<DebugLogEntryTimestamp> queuedLogEntriesTimestamps;
        protected object logEntriesLock;
		private int pendingLogToAutoExpand;

        // Command suggestions that match the currently entered command
        protected List<TextMeshProUGUI> commandSuggestionInstances;
		private int visibleCommandSuggestionInstances = 0;
        protected List<ConsoleMethodInfo> matchingCommandSuggestions;
        protected List<int> commandCaretIndexIncrements;
        ...
        protected int commandInputFieldPrevCaretPos = -1;
        ...
        protected Stack<DebugLogEntry> pooledLogEntries;
        protected Stack<DebugLogItem> pooledLogItems;
        ...
        protected CircularBuffer<string> commandHistory;
        protected int commandHistoryIndex = -1;
		protected string unfinishedCommand;

        // StringBuilder used by various functions
        public StringBuilder sharedStringBuilder;
        ...
        protected System.TimeSpan localTimeUtcOffset;
		...
		protected float lastElapsedSeconds;
#endif
#if !IDG_OMIT_FRAMECOUNT
        protected int lastFrameCount;
#endif

        protected DebugLogEntryTimestamp dummyLogEntryTimestamp;

        // Required in ValidateScrollPosition() function
        protected PointerEventData nullPointerEventData;

		protected System.Action<DebugLogEntry> poolLogEntryAction;
		protected System.Action<DebugLogEntry> removeUncollapsedLogEntryAction;
		protected System.Predicate<DebugLogEntry> shouldRemoveCollapsedLogEntryPredicate;
		protected System.Predicate<DebugLogEntry> shouldRemoveLogEntryToShowPredicate;
        protected System.Action<DebugLogEntry, int> updateLogEntryCollapsedIndexAction;

		// Callbacks for log window show/hide events
		public System.Action OnLogWindowShown, OnLogWindowHidden;

		protected bool isQuittingApplication;
		...
		public virtual void ShowLogWindow()
		{
			// Show the log window
        ...
        protected char OnValidateCommand( string text, int charIndex, char addedChar )
		{
		...
		public virtual void ReceivedLog( string logString, string stackTrace, LogType logType )
		{
			if( isQuittingApplication )
				return;
        ...
        protected void ProcessQueuedLogs( int numberOfLogsToProcess )
		{
        ...
        protected void RemoveOldestLogs( int numberOfLogsToRemove )
		{
        ...
        protected void RemoveUncollapsedLogEntry( DebugLogEntry logEntry )
		{
			if( --logEntry.count <= 0 )
        ...
        protected bool ShouldRemoveCollapsedLogEntry( DebugLogEntry logEntry )
		{
			if( logEntry.count <= 0 )
			{
				PoolLogEntry( logEntry );
        ...
        protected bool ShouldRemoveLogEntryToShow( DebugLogEntry logEntry )
		{
			return logEntry.count <= 0;
		}

        protected void UpdateLogEntryCollapsedIndex( DebugLogEntry logEntry, int collapsedIndex )
		{
			logEntry.collapsedIndex = collapsedIndex;
		}

        protected void OnLogEntriesUpdated( bool updateAllVisibleItemContents, bool validateScrollPosition )
		{
        ...
        protected void PoolLogEntry( DebugLogEntry logEntry )
		{
        ...
        protected void CollapseButtonPressed()
		{
        ...
        protected void FilterLogButtonPressed()
		{
        ...
        protected void FilterWarningButtonPressed()
		{
        ...
        protected void FilterErrorButtonPressed()
		{
        ...
        protected void RefreshCommandSuggestions( string command )
		{
        ...
        protected void OnEditCommand( string command )
		{
        ...
        protected void OnEndEditCommand( string command )
		{
			if( commandSuggestionsContainer.gameObject.activeSelf )
				commandSuggestionsContainer.gameObject.SetActive( false );
		}
        ...
        protected void CheckScreenCutout()
		{
...
#if UNITY_EDITOR || UNITY_STANDALONE || UNITY_WEBGL
        protected IEnumerator ActivateCommandInputFieldCoroutine()
		{
