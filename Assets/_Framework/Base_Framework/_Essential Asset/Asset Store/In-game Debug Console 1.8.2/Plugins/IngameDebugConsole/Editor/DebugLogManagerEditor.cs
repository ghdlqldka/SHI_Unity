...
namespace IngameDebugConsole
{
	...
	{
		protected SerializedProperty singleton;
		protected SerializedProperty minimumHeight;
		protected SerializedProperty enableHorizontalResizing;
		protected SerializedProperty resizeFromRight;
		protected SerializedProperty minimumWidth;
		protected SerializedProperty logWindowOpacity;
		protected SerializedProperty popupOpacity;
		protected SerializedProperty popupVisibility;
		protected SerializedProperty popupVisibilityLogFilter;
		protected SerializedProperty startMinimized;
		protected SerializedProperty toggleWithKey;
		protected SerializedProperty toggleKey;
		protected SerializedProperty enableSearchbar;
		protected SerializedProperty topSearchbarMinWidth;
		protected SerializedProperty copyAllLogsOnResizeButtonClick;
		protected SerializedProperty receiveLogsWhileInactive;
		protected SerializedProperty receiveInfoLogs;
		protected SerializedProperty receiveWarningLogs;
		protected SerializedProperty receiveErrorLogs;
		protected SerializedProperty receiveExceptionLogs;
		protected SerializedProperty captureLogTimestamps;
		protected SerializedProperty alwaysDisplayTimestamps;
		protected SerializedProperty maxLogCount;
		protected SerializedProperty logsToRemoveAfterMaxLogCount;
		protected SerializedProperty queuedLogLimit;
		protected SerializedProperty clearCommandAfterExecution;
		protected SerializedProperty commandHistorySize;
		protected SerializedProperty showCommandSuggestions;
		protected SerializedProperty receiveLogcatLogsInAndroid;
		protected SerializedProperty logcatArguments;
		protected SerializedProperty avoidScreenCutout;
		protected SerializedProperty popupAvoidsScreenCutout;
		protected SerializedProperty autoFocusOnCommandInputField;

		protected readonly GUIContent popupVisibilityLogFilterLabel = new GUIContent( "Log Filter", "Determines which log types will show the popup on screen" );
		protected readonly GUIContent receivedLogTypesLabel = new GUIContent( "Received Log Types", "Only these logs will be received by the console window, other logs will simply be skipped" );
		protected readonly GUIContent receiveInfoLogsLabel = new GUIContent( "Info" );
		protected readonly GUIContent receiveWarningLogsLabel = new GUIContent( "Warning" );
		protected readonly GUIContent receiveErrorLogsLabel = new GUIContent( "Error" );
		protected readonly GUIContent receiveExceptionLogsLabel = new GUIContent( "Exception" );
		...
		protected void DrawSubProperty( SerializedProperty property )
		{
			EditorGUI.indentLevel++;
