...
public class Reporter : MonoBehaviour
{
	...
	protected List<Log> collapsedLogs = new List<Log>();
	...
	protected List<Log> currentLog = new List<Log>();

	//used to check if the new coming logs is already exist or new one
	protected MultiKeyDictionary<string, string, Log> logsDic = new MultiKeyDictionary<string, string, Log>();
	//to save memory
	...
	protected int numOfCollapsedLogs = 0;
	//total number of collapsed warnings
	protected int numOfCollapsedLogsWarning = 0;
	//total number of collapsed errors
	protected int numOfCollapsedLogsError = 0;
	...
	protected bool showMemButton = true;
	protected bool showFpsButton = true;
	protected bool showSearchText = true;
	...
	// gui
	protected GUIContent clearContent;
	protected GUIContent collapseContent;
	protected GUIContent clearOnNewSceneContent;
	protected GUIContent showTimeContent;
	protected GUIContent showSceneContent;
	protected GUIContent userContent;
	protected GUIContent showMemoryContent;
	protected GUIContent softwareContent;
	protected GUIContent dateContent;
	protected GUIContent showFpsContent;
	//GUIContent graphContent;
	protected GUIContent infoContent;
    protected GUIContent saveLogsContent;
	protected GUIContent searchContent;
    protected GUIContent copyContent;
    protected GUIContent closeContent;
	
	protected GUIContent buildFromContent;
	protected GUIContent systemInfoContent;
	protected GUIContent graphicsInfoContent;
	protected GUIContent backContent;
	...
	protected GUIStyle barStyle;
	protected GUIStyle buttonActiveStyle;

	protected GUIStyle nonStyle;
	protected GUIStyle lowerLeftFontStyle;
	protected GUIStyle backStyle;
	protected GUIStyle evenLogStyle;
	protected GUIStyle oddLogStyle;
	protected GUIStyle logButtonStyle;
	protected GUIStyle selectedLogStyle;
	protected GUIStyle selectedLogFontStyle;
	protected GUIStyle stackLabelStyle;
	protected GUIStyle scrollerStyle;
	protected GUIStyle searchStyle;
	protected GUIStyle sliderBackStyle;
	protected GUIStyle sliderThumbStyle;
	protected GUISkin toolbarScrollerSkin;
	protected GUISkin logScrollerSkin;
	protected GUISkin graphScrollerSkin;
	...
	protected Rect toolBarRect = Rect.zero;
	protected Rect logsRect = Rect.zero;
	protected Rect stackRect = Rect.zero;
	protected Rect graphRect = Rect.zero;
	protected Rect graphMinRect = Rect.zero;
	protected Rect graphMaxRect = Rect.zero;
	protected Rect buttomRect = Rect.zero ;
	protected Vector2 stackRectTopLeft;
	protected Rect detailRect = Rect.zero;

	protected Vector2 scrollPosition;
	protected Vector2 scrollPosition2;
	protected Vector2 toolbarScrollPosition;

	//int 	selectedIndex = -1;
	protected Log selectedLog;

	protected float toolbarOldDrag = 0;
	protected float oldDrag;
	protected float oldDrag2;
	protected float oldDrag3;
	protected int startIndex;

	//calculate what is the currentLog : collapsed or not , hide or view warnings ......
	protected virtual void calculateCurrentLog()
	{
	...
	protected Rect countRect = Rect.zero;
	protected Rect timeRect = Rect.zero;
	protected Rect timeLabelRect = Rect.zero;
	protected Rect sceneRect = Rect.zero;
	protected Rect sceneLabelRect = Rect.zero;
	protected Rect memoryRect = Rect.zero;
	protected Rect memoryLabelRect = Rect.zero;
	protected Rect fpsRect = Rect.zero;
	protected Rect fpsLabelRect = Rect.zero;
	protected GUIContent tempContent = new GUIContent();


	protected Vector2 infoScrollPosition;
	protected Vector2 oldInfoDrag;
	...
	protected virtual void drawInfo_enableDisableToolBarButtons()
	{
		GUILayout.BeginHorizontal();
		GUILayout.Space(size.x);
	...
	protected float graphSize = 4f;
	protected int startFrame = 0;
	protected int currentFrame = 0;
	protected Vector3 tempVector1;
	protected Vector3 tempVector2;
	protected Vector2 graphScrollerPos;
	protected float maxFpsValue;
	protected float minFpsValue;
	protected float maxMemoryValue;
	protected float minMemoryValue;
	...
	protected List<Vector2> gestureDetector = new List<Vector2>();
	protected Vector2 gestureSum = Vector2.zero;
	protected float gestureLength = 0;
	...
	protected virtual Vector2 getDownPos()
	{
		if (Application.platform == RuntimePlatform.Android ||
		   Application.platform == RuntimePlatform.IPhonePlayer) {
	...
	protected virtual Vector2 getDrag()
	{
	...
	protected virtual void calculateStartIndex()
	{
	...
	protected const int requiredFrames = 10;
	protected const float updateInterval = 0.25f;
	...
	protected virtual void CaptureLogThread(string condition, string stacktrace, LogType type)
	{
...
#endif
    //new scene is loaded
    protected virtual void _OnLevelWasLoaded( Scene _null1 , LoadSceneMode _null2 )
	{
	...
	protected virtual IEnumerator readInfo()
	{
	...
	protected virtual void SaveLogsToDevice()
    {
