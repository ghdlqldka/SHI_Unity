...
{
	public class _TapDemo : TapDemo
	{
		private static string LOG_FORMAT = "<color=#AB3030><b>[_TapDemo]</b></color> {0}";
		...
		protected ParticleSystem IndicatorPS
		{
			get
			{
				return Indicator;
		...
		protected override void OnEnable()
		{
			...
			_IT_Gesture.onMultiTapE += OnMultiTap;
			_IT_Gesture.onLongTapE += OnLongTap;

			_IT_Gesture.onChargingE += OnCharging;
			_IT_Gesture.onChargeEndE += OnChargeEnd;

			_IT_Gesture.onDraggingStartE += OnDraggingStart;
			_IT_Gesture.onDraggingE += OnDragging;
			_IT_Gesture.onDraggingEndE += OnDraggingEnd;
		}
