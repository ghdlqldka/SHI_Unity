...
{
    public class _UI_PopupDialog_Landscape : _UI_PopupDialog
    {
        private static string LOG_FORMAT = "<color=white><b>[_UI_PopupDialog_</b></color><color=red><b>Landscape]</b></color> {0}";
