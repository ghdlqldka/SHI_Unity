...
namespace _Base_Framework
{
	...
	static public class NGUIEditorTools
	{
		...
		static public Texture2D ImportTexture(string path, bool forInput, bool force, bool alphaTransparency)
		{
			if (string.IsNullOrEmpty(path) == false)
			{
				...
				else if (!MakeTextureAnAtlas(path, force, alphaTransparency))
					return null;
		...
		static public Object previousSelection
		{
			get
			{
				return mPrevious;
	...
	static public bool SelectWidget (GameObject start, Vector2 pos, bool inFront)
	{
		...
		static public void RegisterUndo(string name, Object obj)
		{
			if (obj != null) UnityEditor.Undo.RecordObject(obj, name);
		}
