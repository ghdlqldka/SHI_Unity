...
namespace _Base_Framework
{
	...
	public class _TweenColor : _UITweener
	{
		...
		static public _TweenColor Begin(GameObject go, float duration, Color color)
		{
#if UNITY_EDITOR
			if (!Application.isPlaying) return null;
#endif
			_TweenColor comp = _UITweener.Begin<_TweenColor>(go, duration);
