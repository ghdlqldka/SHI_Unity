...
namespace _Base_Framework
{
	...
	public abstract class _UITweener : MonoBehaviour
	{
		/// <summary>
		/// Current tween that triggered the callback function.
		/// </summary>

		static public _UITweener current;
		...
		public _Base_Framework.Direction direction
		{
			get
			{
				return amountPerDelta < 0f ? _Base_Framework.Direction.Reverse : _Base_Framework.Direction.Forward;
			}
		}
		...
		static public T Begin<T>(GameObject go, float duration, float delay = 0f) where T : _UITweener
		{
