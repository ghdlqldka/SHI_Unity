...
namespace _Base_Framework
{
    ...
    public class _GameObjectRub : MonoBehaviour
    {
        private static string LOG_FORMAT = "<color=#B1C5EF><b>[_GameObjectRub]</b></color> {0}";
        ...
        public UnityEvent<_GameObjectRub> onTriggerEvent = new UnityEvent<_GameObjectRub>();
        ...
        protected virtual void OnMouseDown()
        {
            ...
            RaycastHit hitInfo;
            if (Physics.Raycast(ray, out hitInfo) == false || hitInfo.collider.gameObject != this.gameObject)
            {
                return;
            }
        ...
        public virtual void OnTriggerGameObjectRub(_GameObjectRub gameObjectRub)
        {
            ...
            Debug.LogWarningFormat(LOG_FORMAT, "<b><color=red>OnTrigger</color>GameObjectRub</b>(), gameObjectRub : <b>" + gameObjectRub.gameObject.name + "</b>");
        }
    }
}