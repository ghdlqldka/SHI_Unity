...
namespace KoganeUnityLib
{
	...
	public /*partial*/ class TMP_Typewriter : MonoBehaviour
	{
		...
		// 変数(SerializeField)
		//==============================================================================
		/*[SerializeField]*/ protected TMP_Text m_textUI = null;
		...
		public virtual void Play( string text, float speed, Action onComplete )
		{
			m_textUI.text = text;
		...
		public virtual void Skip( bool withCallbacks = true )
		{
			if ( m_tween != null )
			{
				m_tween.Kill();
