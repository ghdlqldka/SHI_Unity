...
namespace UnityTimer.Examples
{
    public class TestTimerBehaviour : MonoBehaviour
    {
        ...
        protected int _numLoops;
        protected Timer _testTimer;
        ...
        public virtual void StartTestTimer()
        {
            ResetState();
        ...
        public virtual void CancelTestTimer()
        {
        ...
        public virtual void PauseTestTimer()
        {
            Timer.Pause(_testTimer);
        }

        public virtual void ResumeTestTimer()
        {
        ...
        protected virtual bool ShouldShowRestartText()
        {
