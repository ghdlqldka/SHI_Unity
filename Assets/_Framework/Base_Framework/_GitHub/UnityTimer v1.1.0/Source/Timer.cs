...
namespace UnityTimer
{
    public class Timer
    {
        ...
        {
            Debug.Log("Register(), Timer._manager : " + Timer._manager);
...
#pragma warning restore 0618
        ...
        public virtual float GetRatioComplete()
        {
        ...
        public virtual float GetRatioRemaining()
        {
        ...
        protected MonoBehaviour _autoDestroyOwner;
        protected bool _hasAutoDestroyOwner;
        ...
        protected Timer(float duration, Action onComplete, Action<float> onUpdate,
        ...
        protected virtual float GetTimeDelta()
        {
...
#region Manager Class (implementation detail, spawned automatically and updates all registered timers)
        ...
        public class TimerManager : MonoBehaviour
        {
            ...
            protected virtual void UpdateAllTimers()
            {
