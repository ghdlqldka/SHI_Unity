...
namespace Michsky.MUIP
{
    ...
    public class ContextMenuContent : MonoBehaviour, IPointerClickHandler
    {
        ...
        protected Image setItemImage;
        protected TextMeshProUGUI setItemText;
        protected Sprite imageHelper;
        protected string textHelper;
        ...
        public virtual void ProcessContent()
        {
