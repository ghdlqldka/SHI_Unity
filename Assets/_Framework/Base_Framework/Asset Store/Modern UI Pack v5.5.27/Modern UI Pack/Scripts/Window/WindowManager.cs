...
namespace Michsky.MUIP
{
    public class WindowManager : MonoBehaviour
    {
        ...
        // Hidden vars
        protected GameObject currentWindow;
        protected GameObject nextWindow;
        protected GameObject currentButton;
        protected GameObject nextButton;
        protected Animator currentWindowAnimator;
        protected Animator nextWindowAnimator;
        protected Animator currentButtonAnimator;
        protected Animator nextButtonAnimator;

        // Helpers
        protected string windowFadeIn = "In";
        protected string windowFadeOut = "Out";
        protected string buttonFadeIn = "Hover to Pressed";
        string buttonFadeOut = "Pressed to Normal";
        protected float cachedStateLength;
        public bool altMode;
        ...
        // Old method
        public virtual void OpenPanel(string newPanel)
        {
            OpenWindow(newPanel);
        }
