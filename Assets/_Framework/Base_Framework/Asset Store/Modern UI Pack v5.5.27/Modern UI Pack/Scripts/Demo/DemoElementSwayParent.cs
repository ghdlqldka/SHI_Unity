...
namespace Michsky.MUIP
{
    ...
    {
        [SerializeField] protected Animator titleAnimator;
        [SerializeField] protected TextMeshProUGUI elementTitle;
        [SerializeField] protected TextMeshProUGUI elementTitleHelper;

        protected List<DemoElementSway> elements = new List<DemoElementSway>();
        ...
        public virtual void SetWindowManagerButton(int index)
        {
            if (elements.Count == 0)
            {
