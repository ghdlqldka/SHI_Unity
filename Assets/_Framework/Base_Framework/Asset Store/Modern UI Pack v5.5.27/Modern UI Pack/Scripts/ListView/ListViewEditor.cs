...
namespace Michsky.MUIP
{
    ...
    public class ListViewEditor : Editor
    {
        ...
        protected static int SortByNameAtoZ(ListView.ListItem o1, ListView.ListItem o2)
        {
            // Compare the names and sort by A to Z
            return o1.itemTitle.CompareTo(o2.itemTitle);
        }

        protected static int SortByNameZtoA(ListView.ListItem o1, ListView.ListItem o2)
        {
