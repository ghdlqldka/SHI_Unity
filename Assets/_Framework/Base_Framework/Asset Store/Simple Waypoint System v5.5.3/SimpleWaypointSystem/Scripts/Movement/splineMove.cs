...
namespace SWS
{
    ...
    public class splineMove : MonoBehaviour
    {
        ...
        protected Coroutine waitRoutine;
        ...
        protected virtual void Initialize(int startAt = 0)
        {
        ...
        protected void OnWaypointReached(int index)
        {
            if (index <= 0) return;
        ...
        protected void OnWaypointChange(int index)
        {
        ...
        protected void OnWaypointRotation()
        {
        ...
        protected void RandomizeWaypoints()
        {
            Initialize();
        ...
        /// <summary>
        public virtual void Pause(float seconds = 0f)
        {
        ...
        //waiting routine
        protected IEnumerator Wait(float secs = 0f)
        {
        ...
        /// <summary>
        /// Returns whether the movement tween is active, regardless of playing state.
        ...
        //clean up remaining DOTween references when object is destroyed
