...
namespace SWS
{
    ...
    public class PathEditor : Editor
    {
        ...
        protected SerializedProperty m_SkipNames;
        //serialized replace object gameobject
        protected SerializedProperty m_WaypointPref;
        ...
        protected static string wpArraySize = "waypoints.Array.size";
        ...
        protected List<int> activeNode = new List<int>();
        ...
        protected double lastMouseClickTime = 1;
        //tracking of keyboard modifiers pressed
        protected bool isControlPressed = false;
        ...
        */
        ...
        protected Transform[] GetWaypointArray()
        {
        ...
        protected void RemoveWaypointAtIndex(int index)
        {
        ...
        protected void AddWaypointAtIndex(int index)
        {
        ...
        protected void DrawPathOptions()
		{
