...
namespace Lean.Pool
{
	...
	public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		public static LinkedList<LeanGameObjectPool> Instances = new LinkedList<LeanGameObjectPool>(); protected LinkedListNode<LeanGameObjectPool> instancesNode;

		/// <summary>The prefab this pool controls.</summary>
		public GameObject Prefab { set { if (value != prefab) { UnregisterPrefab(); prefab = value; RegisterPrefab(); } } get { return prefab; } } [SerializeField] protected GameObject prefab;
		...
		public NotificationType Notification { set { notification = value; } get { return notification; } } [SerializeField] protected NotificationType notification = NotificationType.IPoolable;
		...
		public StrategyType Strategy { set { strategy = value; } get { return strategy; } } [SerializeField] protected StrategyType strategy = StrategyType.ActivateAndDeactivate;

		/// <summary>Should this pool preload some clones?</summary>
		public int Preload { set { preload = value; } get { return preload; } } [SerializeField] protected int preload;

		/// <summary>Should this pool have a maximum amount of spawnable clones?</summary>
		public int Capacity { set { capacity = value; } get { return capacity; } } [SerializeField] protected int capacity;

		/// <summary>If the pool reaches capacity, should new spawns force older ones to despawn?</summary>
		public bool Recycle { set { recycle = value; } get { return recycle; } } [SerializeField] protected bool recycle;

		/// <summary>Should this pool be marked as DontDestroyOnLoad?</summary>
		public bool Persist { set { persist = value; } get { return persist; } } [SerializeField] protected bool persist;

		/// <summary>Should the spawned clones have their clone index appended to their name?</summary>
		public bool Stamp { set { stamp = value; } get { return stamp; } } [SerializeField] protected bool stamp;

		/// <summary>Should detected issues be output to the console?</summary>
		public bool Warnings { set { warnings = value; } get { return warnings; } } [SerializeField] protected bool warnings = true;
		...
		[SerializeField]
        protected List<GameObject> spawnedClonesList = new List<GameObject>();
        ...
        protected HashSet<GameObject> spawnedClonesHashSet = new HashSet<GameObject>();
		...
		[SerializeField]
        protected List<Delay> delays = new List<Delay>();
		...
		public virtual GameObject Spawn(Transform parent, bool worldPositionStays = false)
		{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public virtual bool TrySpawn(ref GameObject clone, Transform parent, bool worldPositionStays = false)
		{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public virtual bool TrySpawn(ref GameObject clone, Vector3 position, Quaternion rotation, Transform parent = null)
		{
			if (prefab == null) { if (warnings == true) Debug.LogWarning("You're attempting to spawn from a pool with a null prefab", this); return false; }
			if (parent != null)
			{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public virtual bool TrySpawn(ref GameObject clone)
		{
			if (prefab == null) { if (warnings == true) Debug.LogWarning("You're attempting to spawn from a pool with a null prefab", this); return false; }
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public virtual bool TrySpawn(ref GameObject clone, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays)
		{
			if (prefab != null)
			{
		...
		public virtual void DespawnOldest()
		{
        ...
        protected bool TryDespawnOldest(ref GameObject clone, bool registerDespawned)
		{
		...
		public virtual void DespawnAll(bool cleanLinks)
		{
			// Merge
			MergeSpawnedClonesToList();
		...
		public virtual void PreloadOneMore()
		{
			if (prefab != null)
			{
				// Create clone
		...
		public virtual void PreloadAll()
		{
			if (preload > 0)
			{
				if (prefab != null)
        ...
        protected void UnregisterPrefab()
		{
        ...
        protected void DespawnNow(GameObject clone, bool register = true)
		{
			// Add clone to despawned list
			if (register == true)
			{
		...
		protected virtual GameObject CreateClone(Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays)
		{
        ...
        protected GameObject DoInstantiate(GameObject prefab, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays)
		{
#if UNITY_EDITOR
		...
		protected virtual void SpawnClone(GameObject clone, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays)
		{
			// Register
			if (recycle == true)
			{
		...
		protected virtual void InvokeOnSpawn(GameObject clone)
		{
			switch (notification)
			{
		...
		protected virtual void InvokeOnDespawn(GameObject clone)
		{
			switch (notification)
			{
        ...
        protected void MergeSpawnedClonesToList()
		{
...
namespace Lean.Pool.Editor
{
	...
	{
		protected static List<GameObject> tempClones = new List<GameObject>();
		...
		protected virtual void DrawClones(string title, bool spawned, bool despawned, string propertyName)
		{
