...
// Based on StandardShaderGUI

using System;
using UnityEngine;
//using TargetAttributes = UnityEditor.BuildTargetDiscovery.TargetAttributes;//inaccessible due to the protection level

namespace UnityEditor
{
    internal class CrossSectionStandardShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            queueOffset = FindProperty("_QueueOffset", props, false);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            // Detect any changes to the material
            {
                ...
                if (stencilMask != null) m_MaterialEditor.ShaderProperty(stencilMask, "_StencilMask");
                if (stencilComp != null) m_MaterialEditor.ShaderProperty(stencilComp, "_StencilComp");

                EditorGUILayout.Space();
                //EditorGUILayout.LabelField("CapPrepare stencil pass", EditorStyles.boldLabel);
                if (readMask != null) m_MaterialEditor.ShaderProperty(readMask, "_ReadMask");
                if (writeMask != null) m_MaterialEditor.ShaderProperty(writeMask, "_WriteMask");
                ...
                EditorGUILayout.Space();
                if (queueOffset != null) m_MaterialEditor.ShaderProperty(queueOffset, "_QueueOffset");
        ...
        void DoNormalArea()
        {
            ...
            if (bumpScale.floatValue != 1
                //&& BuildTargetDiscovery.PlatformHasFlag(EditorUserBuildSettings.activeBuildTarget, TargetAttributes.HasIntegratedGPU)//inaccessible due to the protection level
                )
        ...
        public static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode, bool overrideRenderQueue)
        {
            ...
            //int qOffset = 0;
            //if(material.HasProperty("_QueueOffset")) qOffset = material.GetInt("_QueueOffset");
            switch (blendMode)
            {
                case BlendMode.Opaque:
                    ...
                    minRenderQueue = -1;
                    //material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Geometry + qOffset;
                ...
                case BlendMode.Cutout:
                    ...
                    material.DisableKeyword("_ALPHABLEND_ON");
                    material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
                    //material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.AlphaTest + qOffset;
                ...
                case BlendMode.Fade:
                    ...
                    material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
                    //material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Transparent + qOffset;
