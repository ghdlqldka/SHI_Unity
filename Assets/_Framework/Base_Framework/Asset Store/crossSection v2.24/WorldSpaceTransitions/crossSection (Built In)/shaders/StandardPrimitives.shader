...
Shader "CrossSection/Primitives/Standard" 
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS
			//#pragma shader_feature_local __ CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS// to get enumerated keywords as local.
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS
			//#pragma multi_compile_local __ CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS// to get enumerated keywords as local.
	...
	SubShader
	{
		...
		Pass {
			...
			#pragma multi_compile CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS
			//#pragma multi_compile_local __ CLIP_CORNER CLIP_PLANE CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS// to get enumerated keywords as local.
