...
// Based on "Standard (Specular setup)"
Shader "CrossSection/Standard (Specular)/Base"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			//#pragma multi_compile_local __ CLIP_CORNER CLIP_PLANE CLIP_SPHERE CLIP_NONE // to get enumerated keywords as local.#pragma shader_feature_local_vertex RETRACT_BACKFACES
			#pragma shader_feature_local_fragment USE_SECTION_COLOR
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_CORNER CLIP_PLANE CLIP_SPHERE CLIP_NONE
			//#pragma multi_compile_local __ CLIP_CORNER CLIP_PLANE CLIP_SPHERE CLIP_NONE // to get enumerated keywords as local.
