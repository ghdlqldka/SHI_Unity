Shader "CrossSection/Others/CapPrepare" {
	...
	Properties{
		...
		[Enum(UnityEngine.Rendering.CompareFunction)] _StencilCompFront("CompFront", Int) = 8
		[Enum(UnityEngine.Rendering.CompareFunction)] _StencilCompBack("CompBack", Int) = 8
    ...
    SubShader {
		...
		Pass {
			...
			#pragma multi_compile_fragment __ CLIP_PLANE CLIP_PIE CLIP_SPHERE CLIP_CORNER CLIP_BOX CLIP_CUBOID
			#pragma vertex vert
