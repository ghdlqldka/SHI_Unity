...
namespace AdvancedGizmo
{
    public class Gizmo : MonoBehaviour
    {
        ...
        protected enum GizmoAxis { X, Y, Z, XY, XZ, YZ, XYRotate, XZRotate, YZRotate, none };
        ...
        protected Vector3 hitvector, mousePos, lookCamera, startDrag, startPos, startDragRot, lookHitPoint;
        protected bool dragging, rotating;

        private EventSystem ES;

        protected float sphereRadius;

        protected GameObject rotationParent;
