...
namespace GoogleSheetsToUnity
{
    ...
    public class GSTU_Cell
    {
        ...
        public virtual void UpdateCellValue(string sheetID, string worksheet, string value, UnityAction callback = null)
        {
            Debug.Log("aaa");
            this.value = value;
        ...
        //TODO: store the sheetId and worksheet in the spreadsheet so dont have to pass these through
        public ValueRange AddCellToBatchUpdate(string sheetID, string worksheet, string value)
        {
            this.value = value;
            List<string> list = new List<string>();
            list.Add(value);
