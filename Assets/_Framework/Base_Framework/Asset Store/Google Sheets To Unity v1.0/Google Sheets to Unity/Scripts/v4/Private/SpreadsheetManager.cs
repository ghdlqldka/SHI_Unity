...
namespace GoogleSheetsToUnity
{
    ...
    {   
        ...
        /// </summary>
        /// <returns></returns>
        protected static IEnumerator CheckForRefreshToken()
        {
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public static IEnumerator Read(UnityWebRequest request, GSTU_Search search, bool containsMergedCells, UnityAction<GstuSpreadSheet> callback)
        {
            if (Application.isPlaying)
            {
        ...
        protected static IEnumerator Write(UnityWebRequest request, UnityAction callback)
        {
            if (Application.isPlaying)
            {
                yield return new Task(CheckForRefreshToken());
        ...
        protected static IEnumerator Append(UnityWebRequest request, UnityAction callback)
        {
            if (Application.isPlaying)
            {
                yield return new Task(CheckForRefreshToken());
