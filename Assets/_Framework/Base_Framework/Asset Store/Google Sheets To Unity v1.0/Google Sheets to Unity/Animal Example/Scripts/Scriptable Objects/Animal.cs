...
public class Animal : ScriptableObject
{
    ...
    public virtual void UpdateStats(GstuSpreadSheet ss)
    {
        items.Clear();
    ...
    public virtual void UpdateStats(GstuSpreadSheet ss, bool mergedCells)
    {
        items.Clear();
        health = int.Parse(ss[name, "Health"].value);
        attack = int.Parse(ss[name, "Attack"].value);
...
public class AnimalEditor : Editor
{
    ...
    protected virtual void OnInspectorGUI_Customization()
    {
        GUILayout.Label("Read Data Examples");
    ...
    protected virtual void UpdateStats(UnityAction<GstuSpreadSheet> callback, bool mergedCells = false)
    {
        SpreadsheetManager.Read(new GSTU_Search(animal.associatedSheet, animal.associatedWorksheet), callback, mergedCells);
    }

    protected void UpdateMethodOne(GstuSpreadSheet ss)
    {
    ...
    protected void UpdateMethodTwo(GstuSpreadSheet ss)
    {
    ...
    protected void UpdateMethodMergedCells(GstuSpreadSheet ss)
    {
    ...
    /// </summary>
    protected virtual void AppendToSheet()
    {
    ...
    /// </summary>
    protected virtual void WriteToSheet()
    {
        List<string> list = new List<string>();
