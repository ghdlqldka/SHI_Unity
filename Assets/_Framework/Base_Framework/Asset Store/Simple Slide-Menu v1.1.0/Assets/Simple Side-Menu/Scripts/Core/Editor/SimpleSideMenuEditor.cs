...
namespace DanielLochner.Assets.SimpleSideMenu
{
    ...
    public class SimpleSideMenuEditor : SSMCopyrightEditor
    {
        ...
        protected void ShowCurrentStateSettings()
        {
        ...
        protected virtual void ShowBasicSettings()
        {
        ...
        protected virtual void ShowDragSettings()
        {
        ...
        protected void ShowOverlaySettings()
        {
