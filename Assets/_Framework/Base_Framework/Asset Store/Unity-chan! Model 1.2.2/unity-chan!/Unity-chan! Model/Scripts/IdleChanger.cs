...
// Require these components when using this script
	...
	public class IdleChanger : MonoBehaviour
	{
		...
		protected Animator anim;                        // Animatorへの参照
		protected AnimatorStateInfo currentState;       // 現在のステート状態を保存する参照
		protected AnimatorStateInfo previousState;	// ひとつ前のステート状態を保存する参照
		...
		// ランダム判定用関数
		protected virtual IEnumerator RandomChange ()
		{
			// 無限ループ開始
			while (true) {
				//ランダム判定スイッチオンの場合
