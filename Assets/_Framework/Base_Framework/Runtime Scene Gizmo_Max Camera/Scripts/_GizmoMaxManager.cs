...
{
	public class _GizmoMaxManager : RuntimeSceneGizmo._RuntimeGizmoManager
    {
        private static string LOG_FORMAT = "<color=#F346C2><b>[_GizmoMaxManager]</b></color> {0}";

        public static new _GizmoMaxManager Instance
        {
            get
            {
                return _instance as _GizmoMaxManager;
            }
            protected set
            {
                _instance = value;
        ...
        [SerializeField]
        protected _GizmoMaxCamera _maxCamera;
        public _GizmoMaxCamera MaxCamera
        {
            get
            {
                return _maxCamera;
