...
{
    [AddComponentMenu("Event/Event System(Base_Framework)")]
    ...
    /// </remarks>
    public class _EventSystem : EventSystem
    {
        private static string LOG_FORMAT = "<color=#FF7F00><b>[_EventSystem]</b></color> {0}";

        public static _EventSystem _current
        {
            get
            {
                return current as _EventSystem;
            }
        }
        ...
        [ReadOnly]
        [SerializeField]
        public bool DEBUG_isPointerOverGameObject;
#endif
