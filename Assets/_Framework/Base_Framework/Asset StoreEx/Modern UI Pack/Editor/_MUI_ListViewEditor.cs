...
{
    [CustomEditor(typeof(_MUI_ListView))]
    public class _MUI_ListViewEditor : ListViewEditor
    {
        protected SerializedProperty m_Script;

        // protected ListView lvTarget;
        protected _MUI_ListView _lvTarget
        {
            get
            {
                return lvTarget as _MUI_ListView;
            }
        }
