...
{
    [CustomEditor(typeof(_MUI_ContextMenuArea))]
    public class _MUI_ContextMenuAreaEditor : ContextMenuContentEditor
    {
        protected SerializedProperty m_Script;

        // protected ContextMenuContent cmcTarget;
        protected _MUI_ContextMenuArea cmaTarget
        {
            get
            {
                return cmcTarget as _MUI_ContextMenuArea;
            }
        }

        protected override void OnEnable()
        {
            cmcTarget = (_MUI_ContextMenuArea)target;
