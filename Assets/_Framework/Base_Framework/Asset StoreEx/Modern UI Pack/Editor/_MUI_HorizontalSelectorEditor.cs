...
{
    [CustomEditor(typeof(_MUI_HorizontalSelector))]
    public class _MUI_HorizontalSelectorEditor : HorizontalSelectorEditor
    {
        protected SerializedProperty m_Script;

        // protected HorizontalSelector hsTarget;
        protected _MUI_HorizontalSelector _hsTarget
        {
            get
            {
                return hsTarget as _MUI_HorizontalSelector;
            }
        }

        // protected UIManagerHSelector tempUIM;
        protected _MUI_HSelectorManager _hsManager
        {
            get
            {
                return tempUIM as _MUI_HSelectorManager;
            }
        }
        ...
        protected override void OnEnable()
        {
            ...
            // base.OnEnable();
            hsTarget = (_MUI_HorizontalSelector)target;

            try 
            { 
                tempUIM = hsTarget.GetComponent<_MUI_HSelectorManager>();
            }
            catch { }
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    if (_hsManager != null)
                    {
                        ...
                        _hsManager.overrideColors = MUIPEditorHandler.DrawToggle(_hsManager.overrideColors, customSkin, "Override Colors");
                        _hsManager.overrideFonts = MUIPEditorHandler.DrawToggle(_hsManager.overrideFonts, customSkin, "Override Fonts");
