...
{
    [CustomEditor(typeof(_MUI_ProgressBar))]
    public class _MUI_ProgressBarEditor : ProgressBarEditor
    {
        protected SerializedProperty m_Script;

        protected _MUI_ProgressBar _pbTarget
        {
            get
            {
                return pbTarget as _MUI_ProgressBar;
            }
        }
        // protected UIManagerProgressBar tempUIM;
        protected _MUI_ProgressBarManager pbManager
        {
            get
            {
                return tempUIM as _MUI_ProgressBarManager;
            }
        }
        // protected UIManagerProgressBarLoop tempFilledUIM;
        protected _MUI_ProgressBarLoopManager pbLoopManager
        {
            get
            {
                return tempFilledUIM as _MUI_ProgressBarLoopManager;
            }
        }
        ...
        protected override void OnEnable()
        {
            ...
            pbTarget = (_MUI_ProgressBar)target;

            try
            {
                if (pbTarget.isLooped == false) 
                {
                    // tempUIM = pbTarget.GetComponent<UIManagerProgressBar>(); 
                    tempUIM = pbTarget.GetComponent<_MUI_ProgressBarManager>();
                }
                else 
                {
                    // tempFilledUIM = pbTarget.GetComponent<UIManagerProgressBarLoop>(); 
                    tempFilledUIM = pbTarget.GetComponent<_MUI_ProgressBarLoopManager>();
                }
            }
            catch 
            { 
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 2:
                    ...
                    if (pbManager != null && pbTarget.isLooped == false)
                    {
                        ...
                        pbManager.overrideColors = MUIPEditorHandler.DrawToggle(pbManager.overrideColors, customSkin, "Override Colors");
                        pbManager.overrideFonts = MUIPEditorHandler.DrawToggle(pbManager.overrideFonts, customSkin, "Override Fonts");
                    ...
                    else if (pbManager == null && pbLoopManager == null)
                    {
