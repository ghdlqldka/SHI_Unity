...
{
	public class _ThirdPersonCharacter : MonoBehaviour
	{
		private static string LOG_FORMAT = "<color=magenta><b>[_ThirdPersonCharacter]</b></color> {0}";

		[ReadOnly]
		[SerializeField]
		protected _ThirdPersonController controller;
		[ReadOnly]
		[SerializeField]
		...
		public float RotationSmoothTime
		{
			...
			set
			{
				...
				controller.RotationSmoothTime = value;
			}
		}
		...
		public float CameraAngleOverride
		{
			get
			{
				return cameraAngleOverride;
			}
			set
			{
				cameraAngleOverride = value;
				controller.CameraAngleOverride = value;
			}
		}
		...
		public bool LockCameraPosition
		{
			...
			set
			{
				...
				controller.LockCameraPosition = value;
			}
		}
		...
		protected virtual void Awake()
		{
			...
			controller.JumpTimeout = JumpTimeout;
			controller.FallTimeout = FallTimeout;
			...
			controller.CameraAngleOverride = CameraAngleOverride;
			controller.LockCameraPosition = LockCameraPosition;
