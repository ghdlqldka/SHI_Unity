...
{
    public class _JsonParser : _ChartParser
    {
        protected JSONNode mBaseJson;
        protected JSONNode mRelativePath;

        public _JsonParser(string data)
        {
            Debug.Log("data:" + data);
        ...
        protected object GetObjectFromRoot(JSONNode root, string name)
        {
