...
namespace _Magenta_WebGL
{
	...
	[CustomEditor(typeof(MWGL_CwGraduallyFade))]
	public class MWGL_CwGraduallyFadeEditor : PaintCore._CwGraduallyFadeEditor
    {
		protected override void OnInspector()
		{
            ...
            // base.OnInspector();
            MWGL_CwGraduallyFade tgt;
            MWGL_CwGraduallyFade[] tgts; 
