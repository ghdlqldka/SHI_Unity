...
namespace _Magenta_WebGL
{
	...
	public class MWGL_CwDragPitchYaw : PaintIn3D._CwDragPitchYaw
    {
        protected override void OnEnable()
        {
            MWGL_CwInputManager.EnsureThisComponentExists();

            MWGL_CwInputManager.OnFingerDown += HandleFingerDown;
            MWGL_CwInputManager.OnFingerUp += HandleFingerUp;
        }
    }
}
