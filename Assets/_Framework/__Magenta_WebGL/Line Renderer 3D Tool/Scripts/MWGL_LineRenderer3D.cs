...
namespace _Magenta_WebGL
{
    ...
    public class MWGL_LineRenderer3D : _Magenta_Framework.LineRenderer3D_Ex
    {
        private static string LOG_FORMAT = "<color=#FFC300><b>[MWGL_LineRenderer3D]</b></color> {0}";
        ...
        protected new Mesh _Mesh
        {
            get
            {
                ...
                {
                    _mesh = new Mesh();
                    _mesh.name = "MagentaWebGL_Mesh_" + Guid.NewGuid().ToString();
        ...
        [SerializeField]
        protected float _width = 0.25f;
        protected float _internalWidth = 0.25f;
        public float _Width
        {
            get
            {
            ...
            set
            {
                if (_internalWidth != value)
                {
                    ...
                    width = new AnimationCurve(new Keyframe(0, _internalWidth), new Keyframe(1, _internalWidth));
                }
            }
        }
