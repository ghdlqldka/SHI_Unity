...
namespace _Magenta_WebGL
{
    ...
    public class MWGL_LineRenderer3D_Gizmo : MWGL_LineRenderer3D
    {
        private static string LOG_FORMAT = "<color=#FFC300><b>[MWGL_LineRenderer3D_Gizmo]</b></color> {0}";
        ...
        protected List<MWGL_Gizmo> _gizmoList = new List<MWGL_Gizmo>();
        public List<MWGL_Gizmo> _GizmoList
        {
            get
            {
                return _gizmoList;
