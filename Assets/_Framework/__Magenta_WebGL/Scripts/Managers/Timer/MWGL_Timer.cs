...
{
    [Serializable]
    public class MWGL_Timer : _Magenta_Framework.TimerEx
    {
        private static string LOG_FORMAT = "<color=#02F5FF><b>[MWGL_Timer]</b></color> {0}";

        public MWGL_Timer() : base()
        {
            //
        }

        public MWGL_Timer(float duration, Action<Guid> onCompleted, Action<Guid, float> onUpdated, bool isLoop, bool usesRealTime) 
            : base()
        {
