...
namespace BioIK {
	...
	public class BioIKEditor : Editor {
		...
		protected Color Color3 = new Color(0.6f, 0.6f, 0.6f, 1f);
		protected Color Color4 = new Color(0.3f, 0.8f, 0.8f, 1f);
		protected Color Color5 = new Color(1f, 0.7f, 0.3f, 1f);
		protected Color Color6 = new Color(0.9f, 0.3f, 0.9f, 1f);
		protected Color Color7 = new Color(1.0f, 0.3f, 0.3f, 1f);
		protected Color Color8 = new Color(0.3f, 0.6f, 0.6f, 1f);
        protected Color Color9 = new Color(0.4f, 0.9f, 0.4f, 1f);
        //private Color Color10 = new Color(1f, 0.5f, 1f, 1f);
        protected Color Color11 = new Color(0.3f, 0.3f, 0.3f, 1f);
        //private Color Color12 = new Color(0.9f, 0.6f, 0.9f, 1f);
        protected Color Color13 = new Color(0.5f, 0.5f, 0.5f, 1f);
        protected Color Color14 = new Color(0.75f, 0.75f, 0.75f, 1f);
...
#pragma warning restore 0618
		...
		protected virtual void MakeInvisible(Transform t) {
			if(t.GetComponent<BioSegment>()) {
		...
		protected virtual void PlaymodeStateChanged() {
        ...
        protected void InspectBody(BioSegment segment, int indent, int maxIndent) {
			SetGUIColor(Color11);
        ...
        protected void ComputeMaxIndentLevel(Transform t, int level, ref int maxIndent) {
