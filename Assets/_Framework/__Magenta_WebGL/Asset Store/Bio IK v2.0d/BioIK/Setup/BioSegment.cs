...
namespace BioIK {
	...
	public class BioSegment : MonoBehaviour {
		...
		protected virtual void Awake() {
			Debug.LogError("[BioSegment]Awake(), this.gameObject : " + this.gameObject.name);
		}
		...
		public virtual BioJoint AddJoint() {
			if(Joint != null) {
		...
		public virtual BioObjective AddObjective(ObjectiveType type) {
