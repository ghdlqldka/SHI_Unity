...
namespace BioIK {
	...
	public class BioJoint : MonoBehaviour {
		...
		[SerializeField] protected Vector3 Anchor = Vector3.zero;						//Joint anchor
		...
		protected virtual void Awake() {
			Debug.LogError("[BioJoint]Awake(), this.gameObject : " + this.gameObject.name);
		}
		...
		public class Motion {
            ...
            protected const double Speedup = 1.0;
			protected const double Slowdown = 1.0;
			...
			protected virtual void UpdateRealistic() {
