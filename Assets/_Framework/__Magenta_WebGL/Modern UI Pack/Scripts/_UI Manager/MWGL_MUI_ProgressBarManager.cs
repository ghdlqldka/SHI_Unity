...
{
    [ExecuteInEditMode]
    public class MWGL_MUI_ProgressBarManager : _Magenta_Framework.MUI_ProgressBarManagerEx
    {
        // private static string LOG_FORMAT = "<color=#CD9A9A><b>[MWGL_MUI_ProgressBarManager]</b></color> {0}";
