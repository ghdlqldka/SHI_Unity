...
{
    // [ExecuteInEditMode]
    public class _Magenta_WebGL_BuildSettings
    {
        private static string LOG_FORMAT = "<color=cyan><b>[_Magenta_WebGL_BuildSettings]</b></color> {0}";
        ...
        [MenuItem("Build Settings/Magenta_WebGL")]
        protected static void BuildFor_PC_Android_IOS()
        {
            ClearUnityConsole();

            Debug.LogWarningFormat(LOG_FORMAT, "BuildFor_PC_Android_IOS()" + ", ProductName : <b><color=blue>" + _Magenta_WebGL_Config.productName + "</color></b>");

            PlayerSettings.companyName = _Magenta_WebGL_Config.companyName;
            PlayerSettings.productName = _Magenta_WebGL_Config.productName;

            // Icon
            string iconFilePath = _Magenta_WebGL_Config.IconFilePath;
        ...
        private static void SetResolutionAndPresentation()
        {
            ...
            PlayerSettings.defaultIsNativeResolution = _Magenta_WebGL_Config.DefaultIsNativeResolution;
            Debug.LogFormat(LOG_FORMAT, "PlayerSettings.defaultIsNativeResolution : <b>" + PlayerSettings.defaultIsNativeResolution + "</b>");
            if (_Magenta_WebGL_Config.DefaultIsNativeResolution == false)
            {
                PlayerSettings.defaultScreenWidth = _Magenta_WebGL_Config.DefaultScreenWidth;
                PlayerSettings.defaultScreenHeight = _Magenta_WebGL_Config.DefaultScreenHeight;
            }
        ...
        private static void SetOtherSettings()
        {
            ...
            PlayerSettings.SetApplicationIdentifier(NamedBuildTarget.FromBuildTargetGroup(targetGroup), _Magenta_WebGL_Config.applicationIdentifier);
            Debug.LogFormat(LOG_FORMAT, "PlayerSettings.applicationIdentifier : <b>" + PlayerSettings.applicationIdentifier + "</b>");
            PlayerSettings.bundleVersion = "" + _Magenta_WebGL_Config.bundleVersion;
            Debug.LogWarningFormat(LOG_FORMAT, "PlayerSettings.bundleVersion : <b>" + PlayerSettings.bundleVersion + "</b>");

#if UNITY_ANDROID
            PlayerSettings.Android.bundleVersionCode = _Magenta_WebGL_Config.bundleVersionCode;
        ...
        private static void AddScenesInBuild()
        {
            ...
            scenePathList.Add(_Magenta_WebGL_Config.RootPath + "/Scenes/Test.unity");
