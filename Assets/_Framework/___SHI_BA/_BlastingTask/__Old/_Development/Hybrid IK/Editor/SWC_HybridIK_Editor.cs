...
namespace _SHI_BA
{
    [CustomEditor(typeof(SWC_HybridIK))]
    public class SWC_HybridIK_Editor : _Magenta_WebGL.MWGL_HybridIK_Editor
    {
        private static string LOG_FORMAT = "<color=#F85AA7><b>[SWC_HybridIK_Editor]</b></color> {0}";

        // protected SerializedProperty m_Script;

        protected new SWC_HybridIK hybridIKNode
        {
            get
            {
                return target as SWC_HybridIK;
            }
        }
