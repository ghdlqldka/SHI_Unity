...
namespace _SHI_BA
{
    public class BA_HttpGetRequest : _Magenta_WebGL.MWGL_HttpGetRequest
    {
        private static string LOG_FORMAT = "<b><color=#61AFFE>[BA_Http</color><color=red>Get</color><color=#61AFFE>Request]</color></b> {0}";
