...
namespace _SHI_BA
{
    public class BA_HttpPostRequest : _Magenta_WebGL.MWGL_HttpPostRequest
    {
        private static string LOG_FORMAT = "<b><color=#49CC90>[BA_Http</color><color=red>Post</color><color=#49CC90>Request]</color></b> {0}";
