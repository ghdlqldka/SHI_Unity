...
{
    // [ExecuteInEditMode]
    public class _SHI_BA_BuildSettings
    {
        private static string LOG_FORMAT = "<color=cyan><b>[_SHI_BA_BuildSettings]</b></color> {0}";
        ...
        [MenuItem("Build Settings/SHI_BA")]
        protected static void BuildFor_PC_Android_IOS()
        {
            ClearUnityConsole();

            Debug.LogWarningFormat(LOG_FORMAT, "BuildFor_PC_Android_IOS()" + ", ProductName : <b><color=blue>" + _SHI_BA_Config.productName + "</color></b>");

            PlayerSettings.companyName = _SHI_BA_Config.companyName;
            PlayerSettings.productName = _SHI_BA_Config.productName;

            // Icon
            string iconFilePath = _SHI_BA_Config.IconFilePath;
        ...
        private static void SetResolutionAndPresentation()
        {
            ...
            PlayerSettings.defaultIsNativeResolution = _SHI_BA_Config.DefaultIsNativeResolution;
            Debug.LogFormat(LOG_FORMAT, "PlayerSettings.defaultIsNativeResolution : <b>" + PlayerSettings.defaultIsNativeResolution + "</b>");
            if (_SHI_BA_Config.DefaultIsNativeResolution == false)
            {
                PlayerSettings.defaultScreenWidth = _SHI_BA_Config.DefaultScreenWidth;
                PlayerSettings.defaultScreenHeight = _SHI_BA_Config.DefaultScreenHeight;
            }
        ...
        private static void SetOtherSettings()
        {
            ...
            PlayerSettings.SetApplicationIdentifier(NamedBuildTarget.FromBuildTargetGroup(targetGroup), _SHI_BA_Config.applicationIdentifier);
            Debug.LogFormat(LOG_FORMAT, "PlayerSettings.applicationIdentifier : <b>" + PlayerSettings.applicationIdentifier + "</b>");
            PlayerSettings.bundleVersion = "" + _SHI_BA_Config.bundleVersion;
        ...
        private static void AddScenesInBuild()
        {
            ...
            scenePathList.Add(_SHI_BA_Config.RootPath + "/Scenes/Test.unity");
