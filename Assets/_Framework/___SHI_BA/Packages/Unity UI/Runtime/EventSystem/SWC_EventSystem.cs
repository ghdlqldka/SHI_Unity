...
namespace _SHI_BA
{
    ...
    /// </remarks>
    public class SWC_EventSystem : _Magenta_WebGL.MWGL_EventSystem
    {
        private static string LOG_FORMAT = "<color=#FF7F00><b>[SWC_EventSystem]</b></color> {0}";

        public static new SWC_EventSystem _current
        {
            get
            {
                return current as SWC_EventSystem;
            }
        }
