...
{
	public class TapDemoEx : _InputTouches._TapDemo
    {
		private static string LOG_FORMAT = "<color=#AB3030><b>[TapDemoEx]</b></color> {0}";
		...
		protected override void OnEnable()
		{
			...
			IT_GestureEx.onMultiTapE += OnMultiTap;
            IT_GestureEx.onLongTapE += OnLongTap;
            ...
            IT_GestureEx.onDraggingEndE += OnDraggingEnd;
		}
