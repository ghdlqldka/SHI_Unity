...
{
	public class LogViewerEx : _Base_Framework._LogViewer
    {
		private static string LOG_FORMAT = "<color=#FF00DA><b>[LogViewerEx]</b></color> {0}";

		public static new LogViewerEx Instance
		{
			get
			{
				return _instance as LogViewerEx;
			}
			protected set
			{
				_instance = value;
		...
		protected override void Awake()
		{
			...
			{
				string __PREFIX__ = _Magenta_Framework_Config.Product + "_";
