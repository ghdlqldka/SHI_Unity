...
namespace _Magenta_Framework //ZenFulcrum.EmbeddedBrowser
{
	/**
	 * Getting CEF running on a build result requires some fiddling to get all the files in the right place.
	 */
	class _Magenta_Framework_PostProcessBuild //PostBuildStandalone
	{
		private static string LOG_FORMAT = "<color=magenta><b>[_Magenta_Framework_PostProcessBuild]</b></color> {0}";
		...
		*/
		static readonly List<string> __copyFileList__ = new List<string>(){"Magenta_Framework_AppConfig.ini"};
		...
		public static void PostprocessBuild(BuildTarget target, string buildFile)
		{
			try
			{
				...
				{
					Debug.LogWarningFormat(LOG_FORMAT, "This is NOT <b><color=red>Magenta_Framework</color></b>!!!!!");
					return;
				}
