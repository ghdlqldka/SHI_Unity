...
{
    public static class _Magenta_Framework_Config
    {
        private static string LOG_FORMAT = "<color=red><b>[_Magenta_Framework_Config]</b></color> {0}";

        public static string RootPath
        {
            get
            {
                return "Assets/_Framework/_Magenta_Framework";
            }
        }
        ...
        public static string bundleVersion
        {
            get
            {
                return _Base_Framework_Config.bundleVersion;
            }
            set
            {
                _Base_Framework_Config.bundleVersion = value;
            }
        }
        ...
        public static int bundleVersionCode
        {
            get
            {
                return _Base_Framework_Config.bundleVersionCode;
            }
        }
        ...
        public static _Base_Framework._Base_Framework_Config._Product Product
        {
            get
            {
                return _Base_Framework_Config.Product;
            }
            set
            {
                _Base_Framework_Config.Product = value;
            }
        }
        ...
        public static bool DefaultIsNativeResolution
        {
            get
            {
                return _Base_Framework_Config.DefaultIsNativeResolution;
            }
            set
            {
                _Base_Framework_Config.DefaultIsNativeResolution = value;
            }
        }
        ...
        public static int DefaultScreenWidth
        {
            get
            {
                return _Base_Framework_Config.DefaultScreenWidth;
            }
            set
            {
                _Base_Framework_Config.DefaultScreenWidth = value;
            }
        }
        ...
        public static int DefaultScreenHeight
        {
            get
            {
                return _Base_Framework_Config.DefaultScreenHeight;
            }
            set
            {
                _Base_Framework_Config.DefaultScreenHeight = value;
            }
        }
        ...
        static _Magenta_Framework_Config()
        {
            Product = _Base_Framework._Base_Framework_Config._Product.Magenta_Framework;
            ...
            if (Product == _Base_Framework._Base_Framework_Config._Product.Magenta_Framework)
            {
                Product = _Base_Framework._Base_Framework_Config._Product.Magenta_Framework;
                bundleVersion = "1.0.0";
            }
