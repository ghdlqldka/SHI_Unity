...
{
    [CustomEditor(typeof(LineRenderer3D_Ex))]
    public class LineRenderer3D_ExEditor : EA.Line3D.Editor._LineRenderer3DEditor
    {
        // protected LineRenderer3D line;
        protected new LineRenderer3D_Ex _line
        {
            get
            {
                return line as LineRenderer3D_Ex;
            }
        }

        public override void OnInspectorGUI()
        {
            line = target as LineRenderer3D_Ex;
