    ...
    public class MeasurementManagerV2 : MonoBehaviour
    {
        ...
        public virtual void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0) && Input.GetKey(altKey) == false)
            {
                ...
                //PointCloudMath.DebugHighLightPointGreen(ray.origin);

                //ray.origin = ray.GetPoint(cam.nearClipPlane) + rayOffsetFromNearClip);
                //Debug.Log("rayOffsetFromNearClip="+ rayOffsetFromNearClip);
                ...
                //Debug.DrawRay(ray.origin, ray.direction * 100f, Color.blue, 22);
                //Debug.DrawRay(invertedRay.origin, invertedRay.direction * 100, Color.yellow, 22);
                //Debug.DrawLine(invertedRay.origin, invertedRay.origin + invertedRay.direction * 100f, Color.red, 22);
        ...
        protected virtual void PointSelected(Vector3 pos)
        {
            // debug lines only
