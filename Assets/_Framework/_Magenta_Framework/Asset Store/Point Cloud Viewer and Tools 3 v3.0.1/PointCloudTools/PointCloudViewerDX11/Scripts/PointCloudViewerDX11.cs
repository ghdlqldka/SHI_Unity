...
namespace pointcloudviewer.binaryviewer
{
    ...
    public class PointCloudViewerDX11 : MonoBehaviour
    {
        ...
        protected float[] byteArrayToFloats;
        ...
        protected Matrix4x4 Matrix4x4identity = Matrix4x4.identity;
        ...
        protected virtual void Start()
        {
            ...
            {
                Debug.LogError("URP and URP custom passes cannot be used at the same time, please disable one of them");
            }
            ...
            if (useURPCustomPass == true)
            {
                ...
                if (currentPipelineAsset == null) Debug.LogError("URP Custom Pass is enabled, but URP is not installed. Please disable URP Custom Pass or install URP");
            }
            ...
            if (useHDRPCustomPass == true)
            {
                // NOTE doesnt actually check if URP is used, but if has any srp
                RenderPipelineAsset currentPipelineAsset = GraphicsSettings.defaultRenderPipeline;
                if (currentPipelineAsset == null) Debug.LogError("HDRP Custom Pass is enabled, but HDRP is not installed. Please disable HDRP Custom Pass or install HDRP");
            }
        ...
        public virtual void ReadPointCloud()
        {
            isReady = false;
        ...
        public virtual void CallReadPointCloudThreaded(string fullPath)
        {
            isReady = false;
        ...
        // v2 format
        public virtual void ReadPointCloudThreadedNew(System.Object a)
        {
            isReady = false;
        ...
        public virtual void ReadPointCloudThreaded(System.Object a)
        {
            isReady = false;
            ...
            Debug.Log("Loading old v1/v2 format: " + totalPoints + " points..");
        ...
        public virtual void UpdatePointData()
        {
        ...
        public virtual void UpdateColorData()
        {
        ...
        protected void Invoke_OnLoadingComplete(string a)
        {
        ...
        public virtual void AdjustVisiblePointsAmount(int offsetAmount)
        {
            if (isNewFormat == true)
            {
        ...
        public virtual void SetVisiblePointCount(int amount)
        {
            if (isNewFormat == true)
            {
                // TODO wait for load to finish (probably increased last click already)
        ...
        public virtual void ToggleCloud(bool state)
        {
            displayPoints = state;
        ...
        public virtual void FixMainThreadHelper()
        {
