...
namespace PointCloudViewer
{
    public class PointCloudManager : MonoBehaviour
    {
        ...
        protected Thread pointPickingThread;
        ...
        protected virtual void ProcessCloud(string cloudPath)
        {
        ...
        // register new viewer manually to be processed for point picking
        public virtual void RegisterCloudManually(PointCloudViewerDX11 newViewer)
        {
            for (int i = 0; i < viewers.Count; i++)
            {
        ...
        public virtual void CloudIsReady(object cloudFilePath)
        {
        ...
        public virtual void RunPointPickingThread(Ray ray)
        {
        ...
        public virtual void FindClosestPoint(object rawRay)
        {
            System.Diagnostics.Stopwatch stopwatch = new System.Diagnostics.Stopwatch();
            stopwatch.Start();
        ...
        protected void PointCallBack(System.Object a)
        {
        ...
        public virtual bool BoundsIntersectsCloud(Bounds box)
        {
        ...
        public virtual List<CollectedPoint> ConvexHullSelectPoints(GameObject go, List<Vector3> area)
        {
            // build area bounds
