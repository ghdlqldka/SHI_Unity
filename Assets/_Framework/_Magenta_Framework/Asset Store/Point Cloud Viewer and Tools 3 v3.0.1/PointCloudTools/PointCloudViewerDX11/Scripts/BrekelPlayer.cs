...
namespace pointcloudviewer.brekel
{
    public class BrekelPlayer : MonoBehaviour
    {
        ...
        protected int[] numberOfPointsPerFrame;
        protected Int64[] frameBinaryPositionForEachFrame;
        protected Vector3[] animatedPointArray;
        protected Vector3[] animatedColorArray;
        protected int totalNumberOfPoints; // total point count, with padding if enabled
        protected int currentFrame = 0;
        protected int[] animatedOffset;
        protected float nextFrameTimer = 0.0F;

        protected byte binaryVersion = 0;
        ...
        protected Vector3[] clearArray; // temp clearing array

        protected float frameRate = 0; // not used

        protected bool isLoading = false;
        protected bool haveError = false;
        ...
        protected const int sizeofInt64 = sizeof(System.Int64);
        protected const int sizeOfSingle = sizeof(System.Single);
        protected const int sizeOfBool = sizeof(System.Boolean);
        protected const int sizeOfByte = sizeof(System.Byte);

        // filestreaming
        protected int pointQueueCount = 0;
        protected Queue<Vector3[]> pointQueue = new Queue<Vector3[]>();
        protected Queue<Vector3[]> colorQueue = new Queue<Vector3[]>();
        protected Thread fileStreamerThread;
        protected bool abortStreamerThread = false;
        ...
        protected int MAXPOINTCOUNT = 0;

        protected bool isInitializingBuffers = false;
        ...
        protected void UpdateFrame()
        {
            ...
            else // full file
            {
                ...
                if (containsRGB == true)
                    Array.Copy(animatedColorArray, animatedOffset[currentFrame], pointColors, 0, currentFramePointCount);
        ...
        protected virtual void ReadAnimatedPointCloud(System.Object objfileName)
        {
            isLoading = true;
            ...
            if (fileSize >= 2147483647 || useLargeFileStreaming == true)
            {
                ...
                using (BinaryReader binReader = new BinaryReader(fs))
                {
                    ...
                    MainThread.Call(InitBuffersForStreaming);
            ...
            isLoading = false;
            MainThread.Call(OnLoadingCompleteCallBack, fileName);
        ...
        protected virtual void InitBuffersForStreaming()
        {
