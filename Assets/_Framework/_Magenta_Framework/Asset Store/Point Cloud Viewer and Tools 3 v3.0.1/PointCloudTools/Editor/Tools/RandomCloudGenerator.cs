...
namespace pointcloudviewer.generator
{
    ...
    {
        protected static string appName = "RandomCloudGenerator";
        ...
        void OnGUI()
        {
            ...
            {
                if (createBinaryCloud && useNewFormatV2 == true) CreateRandomCloudV2();
                if (createBinaryCloud == true && useNewFormatV2 == false) CreateRandomCloud();
