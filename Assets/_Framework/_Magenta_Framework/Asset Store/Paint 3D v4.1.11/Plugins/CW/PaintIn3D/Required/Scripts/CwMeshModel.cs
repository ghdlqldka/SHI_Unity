...
namespace PaintIn3D
{
	...
	public abstract class CwMeshModel : CwModel
	{
        ...
        protected SkinnedMeshRenderer cachedSkinned;

		[System.NonSerialized]
        protected bool cachedFilterSet;

		[System.NonSerialized]
        protected MeshFilter cachedFilter;

		[System.NonSerialized]
        protected bool cachedSkinnedSet;
        ...
        protected virtual bool TryCacheRenderer()
		{
        ...
        protected virtual void TryGetPrepared(CwCoord coord)
		{
