...
namespace PaintIn3D
{
	...
	public class CwMeshAnalysis : EditorWindow
	{
        ...
        protected int partiallyCount;

        protected float utilizationPercent;

        protected float overlapPercent;

        protected Texture2D overlapTex;
        ...
        protected string[] submeshNames = new string[0];
        ...
        protected Vector3[] arrayA;

        protected List<Vector3> listA = new List<Vector3>();

		protected Vector3[] arrayB;

        protected List<Vector3> listB = new List<Vector3>();

        protected List<float> ratioList = new List<float>();
		...
		protected static bool IsOutside(Vector2 coord)
		{
