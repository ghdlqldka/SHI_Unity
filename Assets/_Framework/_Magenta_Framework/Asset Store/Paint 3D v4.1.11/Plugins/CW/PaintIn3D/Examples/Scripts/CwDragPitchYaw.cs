...
namespace PaintIn3D
{
	...
	public class CwDragPitchYaw : MonoBehaviour
	{
		...
		protected void HandleFingerDown(CwInputManager.Finger finger)
		{
        ...
        protected void HandleFingerUp(CwInputManager.Finger finger)
		{
		...
		private bool CanRotate
		{
			get
			{
				...
				if (tools != null)
				{
					for (var i = 0; i < tools.childCount; i++)
					{
						var child = tools.GetChild(i);
