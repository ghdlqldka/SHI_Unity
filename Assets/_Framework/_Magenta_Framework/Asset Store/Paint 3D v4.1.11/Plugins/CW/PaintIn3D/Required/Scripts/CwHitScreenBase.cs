...
namespace PaintIn3D
{
	...
	public abstract class CwHitScreenBase : CwHitPointers
	{
		...
		[UnityEngine.Serialization.FormerlySerializedAs("draw")] 
		[SerializeField] private EmitType emit;
		...
		public float NormalOffset { set { normalOffset = value; } get { return normalOffset; } } [SerializeField] private float normalOffset;
		...
		protected virtual void PaintAt(CwPointConnector connector, CwHitCache hitCache, Vector2 screenPosition, Vector2 screenPositionOld, bool preview, float pressure, object owner)
		{
		...
		protected void CalcHitData(Vector3 hitPoint, Vector3 hitNormal, Ray ray, Camera camera, Vector2 screenPositionOld, ref Vector3 finalPosition, ref Quaternion finalRotation)
		{
...
{
	using UnityEditor;
	using TARGET = CwHitScreenBase;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwHitScreenBase_Editor : CwEditor
	{
