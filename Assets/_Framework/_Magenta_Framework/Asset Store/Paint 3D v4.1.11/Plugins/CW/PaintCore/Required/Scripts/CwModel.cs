...
namespace PaintCore
{
	...
	public abstract class CwModel : MonoBehaviour
	{
		...
		[System.NonSerialized]
        protected static List<Material> tempMaterials = new List<Material>();
		...
		public static LinkedList<CwModel> Instances { get { return instances; } }
        protected static LinkedList<CwModel> instances = new LinkedList<CwModel>(); 
		protected LinkedListNode<CwModel> instancesNode;
		...
		public virtual Texture GetExistingTexture(CwSlot slot)
		{
