...
{
    protected HybridInverseKinematicsNode hybridIKNode { get { return target as HybridInverseKinematicsNode; } }
    protected List<string> boneHierarchy = new List<string>();

    protected int selectedIKNodeIndex = -1;

    protected int selectedIKKeyframe = -1;
