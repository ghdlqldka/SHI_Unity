...
namespace RosSharp.RosBridgeClient.Actionlib
{
        ...
        where TFeedback : Message
    {
        ...
        protected string ActionAdvertismentId;
        ...
        // When receive a new goal
        protected abstract void OnGoalReceived();
        protected virtual void GoalCallback(TActionGoal actionGoal)
        {
            action.action_goal = actionGoal;
        ...
        protected virtual void CancelCallback(string frameId, string action)
        {
            switch (actionStatus)
            {
        ...
        protected virtual void UpdateAndPublishStatus(ActionStatus actionStatus) // not necessary anymore?
        {
            this.actionStatus = actionStatus;
            //PublishStatus();
        }
