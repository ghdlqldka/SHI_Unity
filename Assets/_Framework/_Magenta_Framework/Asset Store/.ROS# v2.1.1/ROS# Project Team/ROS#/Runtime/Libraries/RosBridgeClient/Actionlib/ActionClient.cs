...
namespace RosSharp.RosBridgeClient.Actionlib 
{
        ...
        where TFeedback : Message
    {
        ...
        public virtual void CancelGoal(string frameId = null)
        {
        ...
        // Implement by user to handle feedback.
        protected abstract void OnFeedbackReceived();
        protected virtual void FeedbackCallback(TActionFeedback actionFeedbackValues)
        {
