...
namespace RosSharp.RosBridgeClient
{
    public class RosSocket
    {
        ...
        {
            UnityEngine.Debug.Log("RosSocket constructor!!!!!!");
        ...
        {
            UnityEngine.Debug.Log("RosSocket.Advertise()");
        ...
        protected void Send<T>(T communication) where T : Communication
        {
            ...
            UnityEngine.Debug.Log("RosSocket.Send(), communication : " + communication);
            // protocol.Send(Serializer.Serialize<T>(communication));
            byte[] data = Serializer.Serialize<T>(communication);
            UnityEngine.Debug.Log("Send(), data : " + data);
            protocol.Send(data);
            return;
        }
        ...
        protected List<Subscriber> SubscribersOf(string topic)
        {
