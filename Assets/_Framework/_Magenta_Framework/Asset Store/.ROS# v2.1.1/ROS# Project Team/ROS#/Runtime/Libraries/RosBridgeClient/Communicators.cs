...
#region Action
    ...
    public abstract class ActionProvider : Communicator
    {
        ...
        public abstract void ListenSendGoalAction(string message, ISerializer serializer);
        public abstract void ListenCancelGoalAction(string frameId, string actionName, ISerializer serializer);
    ...
    public class ActionProvider<TActionGoal> : ActionProvider 
        where TActionGoal : Message

    {
        ...
        public ActionProvider(string action, 
        ...
        public override void ListenSendGoalAction(string message, ISerializer serializer)
        {
            try
            {
        ...
        public override void ListenCancelGoalAction(string frameId, string actionName, ISerializer serializer)
        {
            try
            {
    ...
    public abstract class ActionConsumer : Communicator
    {
        internal abstract string Id { get; }
        internal abstract string Action { get; }
        internal abstract string ActionType { get; }

        public abstract void ConsumeResultResponse(string incomingJsonResultResponse, ISerializer serializer);
        public abstract void ConsumeFeedbackResponse(string incomingJsonFeedbackResponse, ISerializer serializer);
        ...
        where TActionFeedback : Message 
    {
        ...
        public override void ConsumeResultResponse(string incomingJsonResultResponse, ISerializer serializer)
        {
            try
            {
        ...
        public override void ConsumeFeedbackResponse(string incomingJsonFeedbackResponse, ISerializer serializer)
        {
            try
            {
