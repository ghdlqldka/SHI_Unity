...
{
    public class HttpPostRequestEx : _Base_Framework._HttpPostRequest
    {
        private static string LOG_FORMAT = "<b><color=#49CC90>[Http</color><color=red>Post</color><color=#49CC90>RequestEx]</color></b> {0}";
