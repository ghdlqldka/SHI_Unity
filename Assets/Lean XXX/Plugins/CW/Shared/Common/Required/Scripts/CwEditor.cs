...
namespace CW.Common
{
	...
	public abstract class CwEditor : UnityEditor.Editor
	{
		...
		protected static GUIContent customContent = new GUIContent();
		...
		protected static SerializedProperty GetPropertyAndSetCustomContent(string propertyPath, string overrideTooltip, string overrideText)
		{
		...
		protected static string StripRichText(string s)
		{
