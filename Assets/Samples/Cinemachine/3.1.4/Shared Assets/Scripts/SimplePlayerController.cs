...
namespace Unity.Cinemachine.Samples
{
    ...
    public class SimplePlayerController : SimplePlayerControllerBase
    {
        ...
        protected Vector3 m_CurrentVelocityXZ;
        protected Vector3 m_LastInput;
        protected float m_CurrentVelocityY;
        ...
        protected bool m_InTopHemisphere = true;
        protected float m_TimeInHemisphere = 100;
        protected Vector3 m_LastRawInput;
        protected Quaternion m_Upsidedown = Quaternion.AngleAxis(180, Vector3.left);
        ...
        protected Vector3 UpDirection => UpMode == UpModes.World ? Vector3.up : transform.up;
        ...
        protected virtual Quaternion GetInputFrame(bool inputDirectionChanged)
        {
