...
namespace Unity.Cinemachine.Samples
{
    ...
    public class AimTargetManager : MonoBehaviour
    {
        ...
        protected bool m_HaveAimTarget;

        // We add a CameraUpdatedEvent listener so that we are guaranteed to update after the
        // Brain has positioned the camera
        protected virtual void OnEnable() => CinemachineCore.CameraUpdatedEvent.AddListener(SetAimTarget);
        protected virtual void OnDisable() => CinemachineCore.CameraUpdatedEvent.RemoveListener(SetAimTarget);
        ...
        protected virtual void SetAimTarget(CinemachineBrain brain)
        {
