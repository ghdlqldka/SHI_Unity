...
namespace Unity.Cinemachine.Samples
{
    ...
    public class SamplesHelpUI : MonoBehaviour
    {
        ...
        protected VisualElement m_HelpBox;
        protected Button m_HelpButton, m_CloseButton;
        ...
        protected void OpenHelpBox(ClickEvent click)
        {
            if (m_HelpButton != null)
                m_HelpButton.visible = false;
            if (m_HelpBox != null)
        ...
        protected void CloseHelpBox(ClickEvent click)
        {
            if (m_HelpButton != null)
