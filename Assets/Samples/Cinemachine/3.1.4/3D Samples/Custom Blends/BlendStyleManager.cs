...
namespace Unity.Cinemachine.Samples
{
    ...
    {
        public class EarlyLookBlender : CinemachineBlend.IBlender
        {
        ...
        protected EarlyLookBlender m_CustomBlender = new ();

        protected bool m_UseCustomBlend;

        public virtual void OnBlendCreated(CinemachineCore.BlendEventParams evt)
        {
        ...
        public virtual void DefaultBlend()
        {
            m_UseCustomBlend = false;
            ChangeCamera();
        }

        public virtual void CustomBlend()
        {
